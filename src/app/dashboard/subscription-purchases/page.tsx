...
import { subscriptionPurchasesApi, SubscriptionPurchase } from "@/lib/api";

const STATUS_FILTERS = ["all", "ACTIVE", "PAID", "EXPIRED", "TERMINATED"];
      ...
      <div className="flex justify-between items-end mb-8">
        <div>
          ...
          <p className="text-gray-500 italic">
            Subscription plan purchases across all users
          </p>
        </div>
