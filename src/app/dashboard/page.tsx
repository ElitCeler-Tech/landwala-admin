...
export default function Dashboard() {
  ...
  const statCards: StatCardDef[] = [
    ...
    {
      title: `Agents (${rangeSuffix(range)})`,
    ...
    {
      title: `Employees (${rangeSuffix(range)})`,
    ...
    {
      title: `Properties (${rangeSuffix(range)})`,
    ...
    {
      title: `Pending Approval (${rangeSuffix(range)})`,
    ...
    {
      title: `Active Listings (${rangeSuffix(range)})`,
    ...
    {
      title: `Sold Properties (${rangeSuffix(range)})`,
